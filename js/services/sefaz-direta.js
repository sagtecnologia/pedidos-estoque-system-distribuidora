const SefazDireta = {
    ...
    async emitirNFCe(vendaData, itensData, pagamentosData, clienteData = null, options = {}) {
        ...
        return {
            ...
            documento_fiscal_id: resultado.documento_fiscal_id || null,
            persistido_no_servidor: resultado.persistido_no_servidor === true,
            erro_persistencia: resultado.erro_persistencia || null,
